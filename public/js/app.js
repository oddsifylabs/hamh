...
const AGENTS = {
  ...
  miah: {
    ...
    transport: 'poll',
    icon: '🧠',
    description: 'Software coder agent. Writes, deploys, debugs, and reviews code.',
  ...
  markus: {
    ...
    transport: 'poll',
    icon: '📱',
    description: 'Social media manager. Posts, engages, analyzes, and schedules content.',
  ...
  mitch: {
    ...
    transport: 'poll',
    icon: '💼',
    description: 'Sales & marketing manager. Lead gen, CRM, content strategy, and analytics.',
    capabilities: ['sales', 'marketing', 'lead-generation', 'content-strategy', 'analytics', 'crm'],
    templates: ['generate leads', 'sales report', 'marketing campaign', 'crm update'],
    reportsTo: 'octavia',
  },
  ruth: {
    id: 'ruth',
    ...
    transport: 'poll',
    icon: '💻',
    description: 'Web developer. Frontend, backend, UI/UX, deployment, and maintenance.',
